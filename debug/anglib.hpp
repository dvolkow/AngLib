...
namespace anglib
{
	...
	template <typename AriphmeticType, class=std::enable_if_t<is_legal_type<AriphmeticType>>>
	...
	template <
		...
		typename AriphmeticType, class=std::enable_if_t<is_legal_type<AriphmeticType>>
			>
